...
const DEFAULT_ITEMS = [
  { image: "/images/placeholder.webp", alt: "Slide 1" },
  { image: "/images/placeholder.webp", alt: "Slide 2" },
  { image: "/images/placeholder.webp", alt: "Slide 3" },
  { image: "/images/placeholder.webp", alt: "Slide 4" },
  { image: "/images/placeholder.webp", alt: "Slide 5" },
  { image: "/images/placeholder.webp", alt: "Slide 6" },
];

const clamp = (v: number, min: number, max: number) => Math.min(Math.max(v, min), max);
const normalizeItem = (it: string | { image: string; alt?: string }) =>
  ...
  return (
    ...
    >
      ...
      {showIndicators && count > 1 && (
        <div className="depth-carousel__dots" role="tablist" aria-label="Screenshots">
          {data.map((_, i) => (
            <button
              key={i}
              type="button"
